...
export async function insertTier(
  payload: Database['public']['Tables']['tiers']['Insert'] & { pago_unico?: boolean; vigencia_inicio?: string | null; vigencia_fin?: string | null; dias_acceso?: number[] | null }
