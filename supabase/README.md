# Migraciones SQL — SALA Studio / SALA
...
| 20260514100100_tenants.sql | Tabla `tenants` + config jsonb + branding + seed SALA |
| 20260514100200_usuarios.sql | Perfiles extendidos de auth.users con rol y tenant |
| 20260514100300_recursos.sql | Estudios/salas + seed 3 estudios de SALA |
...
- **Códigos de error sin prefijo de marca** (`USUARIO_INACTIVO`, `SLOT_OCUPADO`, etc.): el cliente los traduce a mensajes user-friendly.

## Verificación post-deploy

Después de aplicar las migraciones, verifica en Supabase Studio:

1. Tabla `tenants` tiene 1 fila con `slug = 'sala-demo'`
