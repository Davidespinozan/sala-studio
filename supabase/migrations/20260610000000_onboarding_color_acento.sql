-- ============================================================================
-- Onboarding: color de ACENTO elegible (junto al primario)
-- ============================================================================
-- Antes, crear_tenant_onboarding hardcodeaba branding.color_accent = '#D4A93C'
-- (un dorado ajeno a la marca del gym). Ahora el acento se pide en el wizard y
-- se persiste. Si no se elige (NULL/''), cae al PRIMARIO → marca monocroma
-- segura, nunca el dorado viejo.
--
-- Se agrega el parámetro p_color_acento. Como cambia la firma (13 → 14 args),
-- se hace DROP del overload viejo antes de recrear.
-- ============================================================================

DROP FUNCTION IF EXISTS crear_tenant_onboarding(
