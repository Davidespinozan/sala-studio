-- ============================================================================
-- FIX: crear_tenant_onboarding insertaba la columna `recursos.horarios` que ya
-- no existe → todo alta de gym (onboarding) fallaba con
--   "column \"horarios\" of relation \"recursos\" does not exist" (42703).
-- ----------------------------------------------------------------------------
-- Regresión de ordenamiento: `horarios` se eliminó en 20260522200000
-- (drop_recursos_horarios) y el RPC se corrigió en 20260524400000, pero las
-- redefiniciones posteriores (20260610000000 color_acento, 20260613002400
-- anticipacion_0) copiaron un body viejo que la volvió a incluir. Esta es la
-- MISMA función de 20260613002400 (con anticipacion_min_horas:0 + color_acento)
-- pero con el INSERT de `recursos` SIN `horarios`. No cambia nada más.
-- ============================================================================
...
BEGIN
  ...
  -- ── 5. Primera sala (en la sucursal default) — SIN columna horarios ──
