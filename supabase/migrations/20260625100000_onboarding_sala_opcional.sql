-- ============================================================================
-- Onboarding sin paso "Setup": el alta del gym ya NO pide la primera sala
-- (un gym puede tener varias → no tiene sentido forzar una en el alta). La
-- sala pasa a ser OPCIONAL en crear_tenant_onboarding: si no llega nombre de
-- sala, no se crea ninguna y el dueño las arma desde /admin/recursos, guiado
-- por el ChecklistActivacion ("Crea tu primera sala").
-- ----------------------------------------------------------------------------
-- MISMA función que 20260620300000 (sin recursos.horarios) pero:
--   · p_sala_nombre / p_sala_cupo ahora DEFAULT NULL.
--   · el INSERT de la sala (paso 5) sólo corre si llega nombre de sala.
-- No cambia nada más.
-- ============================================================================
